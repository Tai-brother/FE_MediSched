  ...
  return (
    <>
          ...
          <Row>
            ...
            <Col lg={3} md={6} className="mb-4">
              <div className="stat-item">
                ...
                <div className="stat-label">DỊCH VỤ CẤP CỨU</div>
              </div>
            </Col>
            ...
            <Col lg={3} md={6} className="mb-4">
              <div className="stat-item">
                ...
                <div className="stat-label">HÀI LÒNG BỆNH NHÂN</div>
              </div>
            </Col>
          </Row>
        </Container>
      ...
      <section className="feature-section">
        <Container>
          <h2 className="section-title">CÁC CHUYÊN KHOA TẠI MEDISCHED</h2>
                ...
                <Card className="h-100 shadow-sm border-0 specialty-card">
                  ...
                  <Card.Body className="d-flex flex-column">
                    <div className="mb-3">
                      ...
                      <Badge bg={specialty.color} className="mb-2">
